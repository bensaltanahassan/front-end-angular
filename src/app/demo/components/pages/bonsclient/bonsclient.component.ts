...
@Component({
    selector: 'app-bonsclient',
    templateUrl: './bonsclient.component.html',
    styleUrls: ['./bonsclient.component.scss'],
    providers: [MessageService],
})
export class BonsClientComponent implements OnInit {
        ...
        this.clientService.getAll().subscribe({
            next: (data: any) => {
                this.clients = data?.data.filter(
                    (client) => client.role.id === 2 && client.balance > 20000
                );
            },
        });
